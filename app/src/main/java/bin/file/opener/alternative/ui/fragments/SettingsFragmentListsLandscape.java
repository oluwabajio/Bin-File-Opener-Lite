...
public class SettingsFragmentListsLandscape extends AbstractSettingsFragment implements Preference.OnPreferenceClickListener {
  ...
  public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
    ...
    CheckBoxPreference hexDisplayDataLandscape = findPreference(MyApplication.DLL_LANDSCAPE_HEX_DISPLAY_DATA);
    CheckBoxPreference hexDisplayDataLineNumbersLandscape = findPreference("hexDisplayDataLineNumbersLandscape");
    mHexRowHeightAutoLandscape = findPreference("hexRowHeightAutoLandscape");
    mHexRowHeightLandscape = findPreference("hexRowHeightLandscape");
    mHexFontSizeLandscape = findPreference("hexFontSizeLandscape");
    mHexRowHeightAutoLineNumbersLandscape = findPreference("hexRowHeightAutoLineNumbersLandscape");
    mHexRowHeightLineNumbersLandscape = findPreference("hexRowHeightLineNumbersLandscape");
    mHexFontSizeLineNumbersLandscape = findPreference("hexFontSizeLineNumbersLandscape");
    mPlainRowHeightAutoLandscape = findPreference("plainRowHeightAutoLandscape");
    mPlainRowHeightLandscape = findPreference("plainRowHeightLandscape");
    mPlainFontSizeLandscape = findPreference("plainFontSizeLandscape");
    mLineEditRowHeightAutoLandscape = findPreference("lineEditRowHeightAutoLandscape");
    mLineEditRowHeightLandscape = findPreference("lineEditRowHeightLandscape");
    mLineEditFontSizeLandscape = findPreference("lineEditFontSizeLandscape");
